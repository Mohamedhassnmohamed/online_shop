...
if(isset($_POST['submit'])){
   ...
   if(mysqli_num_rows($select) > 0){
      ...
      mysqli_query($conn, "INSERT INTO `users`(name, email, password,type) VALUES('$name', '$email', '$pass','student')") or die('query failed');
...
<div class="form-container">
   ...
   <form action="" method="post" style="width: 600px; border-radius: 5px; border: 1px solid black; padding: 20px; text-align: center; background-color: lightgray;">
      <h1 style="font-weight: bold;">"مرحبا بك فى المتجر الالكترونى"</h1>
      ...
      <input type="submit" name="submit" class="btn" value="تسجيل حساب" style="background-color: #3E529C;">
